...
for i = 1:100
    ...
    plot(ax1, traj(1, 1:i), traj(2, 1:i), LineStyle='-', Marker='.', DisplayName='Robot Path')
    ...
    if rem(i, 10) == 0 && plotInd <= 10
        ...
        plot(ax2, traj(1, 1:i), traj(2, 1:i), LineStyle='-', Marker='.', DisplayName='Robot Path')
